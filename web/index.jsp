                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p><a class="btn hvr-hover" href="#">Más información</a></p>
                            </div>
                        </div>
                    </div>
                </li>
                <li class="text-center">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Welcome To <br> Cycleshop</strong></h1>
                                <p class="m-b-40">Sal a rodar.. Diviértete <br> Para mí, no importa si está lloviendo o si brilla el sol o lo que sea: mientras conduzca una bicicleta, sé que soy el tipo más afortunado del mundo</p>
                                <p><a class="btn hvr-hover" href="#">Más información</a></p>
                            </div>
                        </div>
                    </div>
                ...
                <li class="text-right">
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <h1 class="m-b-20"><strong>Welcome To <br> Cycleshop</strong></h1>
                                <p class="m-b-40">Sueña en grande <br> Cuando te duele, es cuando puedes marcar la diferencia.</p>
                                <p><a class="btn hvr-hover" href="#">Más información</a></p>
                            </div>
                        </div>
                    </div>
