...
import controllers.ReseniaController;
...
public class SugerenciaServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Resenia resenia = new Resenia(id_cliente, mensaje, calificacion);
            String msj = new ReseniaController().newResenia(resenia);
            out.println(msj);
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SugerenciaServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
